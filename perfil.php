...
$profileusername = $userdata["nomeUsuario"];
...
<body class="profilepage">
    ...
    <div class="showprofile">
        ...
        <p class="name"><?php echo $profileusername?></p>
        ...
        <?php if ($session['account_type'] == 'admin'){?>
            <button class="addgame" onclick='location.href="addgame.php"'>Adicionar jogo</button>
        <?php } }?>
    </div>
</body>
</html>